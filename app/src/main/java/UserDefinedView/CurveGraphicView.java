...
/**
 * Created by Bobofree on 2017/5/8.
 */
public class CurveGraphicView extends View {
     ...
     * 纵坐标值
     */
    private ArrayList<Double> yRawData = null;
    /**
     * 横坐标值
     */
    private ArrayList<String> xRawDatas = null;
    private ArrayList<Integer> xList = new ArrayList<Integer>();// 记录每个x的值
    private int spacingHeight = 0;

    public CurveGraphicView(Context context) {
        this(context, null);
    }

    public CurveGraphicView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(width, height * 2 / 3);
    }
    ...
    protected void onDraw(Canvas canvas) {
        mPaint.setColor(Color.rgb(120, 200, 120));
        ...
        mPaint.setColor(Color.rgb(120, 100, 120));
    ...
    private void drawAllYLine(Canvas canvas) {
        for (int i = 0; i < yRawData.size(); i++) {
            ...
            drawText(xRawDatas.get(i), blwidh + (canvasWidth - blwidh) / yRawData.size() * i, bheight + dip2px(12),
                    canvas);// X坐标
        }
    }
    ...
    private void drawText(String text, int x, int y, Canvas canvas) {
        ...
        p.setColor(Color.rgb(120, 200, 220));
